...
Not my code. The shapefile library wasn't able to be properly installed on my machine so I directly placed a copy of this file in this folder where it was required.
